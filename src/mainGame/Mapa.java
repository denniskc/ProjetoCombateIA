...
public  class Mapa {
	...
	public void AbreMapa(String nomemapa){
		...
		try{
	        	...
	        	mapa2 = new int[getAltura()][getLargura()];
	    ...
	    public void Posiciona(int x,int y){
	        ...
	        if(X < 0){
	            MapX = 0;
	        }else if(X >= (getLargura()-NumeroTilesX)){
	            MapX = ((getLargura()-NumeroTilesX))<<4;
	        }else{
	            MapX = x;
	        ...
	        if(Y < 0){
	            MapY = 0;
	        }else if(Y >= (getAltura()-NumeroTilesY)){
	            MapY = ((getAltura()-NumeroTilesY))<<4;
	        }else{
	            MapY = y;
	        }        
	...
	public int getMap2Pos(int x,int y){
		return mapa2[y][x];
	}
}
